...
<article>
   <div class="grid-container">
      <div class="grid-x grid-padding-x">
         ...
         <aside class="medium-8  cell" data-sticky-container>
            <div class="sticky" data-sticky data-top-anchor="exampleId:top"  data-sticky-on="large">

               <?php
      				if(get_field('inhoudsopgaven')):

      					$inhoudsopgaven_html = '<section class="rightwhiteBox mg-t20"><h2>Inhoudsopgave</h2><div class="spaceall"><div class="broken-coast">';

      					foreach(get_field('inhoudsopgaven') as $inhoud):
      						$inhoud_nr++;
      						$i = 1;
      						$inhoudsopgaven_html .= '<a href="' . $inhoud['anker'] . '">' . $inhoud_nr . '. ' .  $inhoud['titel'] . '</a>';
      							...
      							if($inhoud['subparagrafen']):
      								...
      								foreach($inhoud['subparagrafen'] as $sub):
      									...
      									$inhoudsopgaven_html .= '<li><h6><a href="' . $sub['anker'] . '">' . $inhoud_nr . '.' . $i++ . ' ' . $sub['titel'] . '</a></h6></li>';
      					...
      					$inhoudsopgaven_html .= '</div></div></section>';
